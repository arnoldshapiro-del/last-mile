...
function ChecklistsPage() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "space-y-5" }, /* @__PURE__ */ React.createElement(
  ...
  }), /* @__PURE__ */ React.createElement("div", { className: "ml-auto flex items-center gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement(
    ReadAloudButton,
    {
    ...
    "Reset ",
    cfg.title
  ))), cfg.charts && cfg.charts.length > 0 && /* @__PURE__ */ React.createElement(
    "section",
    {
    ...
    /* @__PURE__ */ React.createElement("h3", { className: "text-base m-0 mb-3", style: { color: cfg.accent } }, "Visual Companion \xB7 ", cfg.title),
    /* @__PURE__ */ React.createElement(ChartGallery, { conceptId: "checklist-" + active, charts: cfg.charts })
  ), /* @__PURE__ */ React.createElement(
    "section",
    {
      className: "rounded-2xl p-5 md:p-6",
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-3 mb-3 flex-wrap" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "text-lg m-0", style: { color: cfg.accent } }, cfg.title, " Checklist"), /* @__PURE__ */ React.createElement("p", { className: "text-sm m-0 mt-0.5", style: { color: "#94a3b8" } }, cfg.desc)), /* @__PURE__ */ React.createElement(
      "div",
      {
    ...
    /* @__PURE__ */ React.createElement("ul", { className: "list-none p-0 m-0 space-y-2" }, cfg.items.map((item, i) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("div", { className: "num shrink-0 mt-0.5", style: { color: cfg.accent, fontSize: "0.75rem" } }, String(i + 1).padStart(2, "0")),
          isDone ? /* @__PURE__ */ React.createElement(CheckCircle2, { className: "w-5 h-5 shrink-0 mt-0.5", style: { color: cfg.accent } }) : /* @__PURE__ */ React.createElement(Circle, { className: "w-5 h-5 shrink-0 mt-0.5", style: { color: "#475569" } }),
          /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0" }, /* @__PURE__ */ React.createElement(
            ...
            item.text
          ), /* @__PURE__ */ React.createElement("div", { className: "text-xs leading-relaxed", style: { color: "#94a3b8" } }, item.detail), item.principleRef !== void 0 && /* @__PURE__ */ React.createElement("div", { className: "mt-2 inline-flex items-center gap-1 text-[10px] uppercase tracking-[0.2em] num", style: { color: "#fbbf24" } }, /* @__PURE__ */ React.createElement(Target, { className: "w-2.5 h-2.5" }), "Principle ", String(item.principleRef).padStart(2, "0")))
        )
      );
    }))
  ));
