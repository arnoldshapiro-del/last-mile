const charts = [
  {
    ...
    candles: [
      ...
      { o: 100, h: 100.3, l: 99.7, c: 99.9 },
      { o: 99.9, h: 101.5, l: 99.85, c: 101.4 },
      // pole bar 1
      { o: 101.4, h: 102.6, l: 101.3, c: 102.5 },
      // pole bar 2
      { o: 102.5, h: 103.6, l: 102.4, c: 103.5 },
      // pole bar 3
      { o: 103.5, h: 104.5, l: 103.4, c: 104.4 },
      // pole bar 4
      { o: 104.4, h: 105.4, l: 104.2, c: 105.2 },
      // pole bar 5
      { o: 105.2, h: 105.4, l: 104.4, c: 104.5 },
      // flag bar 1
      { o: 104.5, h: 104.8, l: 104, c: 104.2 },
      // flag bar 2
      { o: 104.2, h: 104.5, l: 103.9, c: 104.1 },
      // flag bar 3
      { o: 104.1, h: 104.4, l: 103.8, c: 104 },
      // flag bar 4
      { o: 104, h: 105.6, l: 103.95, c: 105.4 }
      // breakout
    ],
    annotations: [
      ...
      { type: "badge", at: { i: 4, price: 103 }, text: "POLE", color: "#22c55e" }
    ],
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100, h: 100.1, l: 98.6, c: 98.7 },
      // pole bar 1
      { o: 98.7, h: 98.8, l: 97.5, c: 97.6 },
      // pole bar 2
      { o: 97.6, h: 97.7, l: 96.4, c: 96.5 },
      // pole bar 3
      { o: 96.5, h: 96.6, l: 95.4, c: 95.5 },
      // pole bar 4
      { o: 95.5, h: 95.6, l: 94.6, c: 94.7 },
      // pole bar 5
      { o: 94.7, h: 95.5, l: 94.6, c: 95.4 },
      // flag bar 1
      { o: 95.4, h: 95.9, l: 95.3, c: 95.7 },
      // flag bar 2
      { o: 95.7, h: 96, l: 95.5, c: 95.8 },
      // flag bar 3
      { o: 95.8, h: 95.95, l: 95.5, c: 95.6 },
      // flag bar 4
      { o: 95.6, h: 95.7, l: 94, c: 94.1 }
      // breakdown
    ],
    annotations: [
      { type: "zone", topPrice: 100, bottomPrice: 94.7, color: "rgba(255, 61, 90, 0.07)", label: "POLE \u2014 5 bars, sustained drop" },
  ...
  },
  {
    ...
    candles: [
      { o: 100, h: 100.5, l: 99.8, c: 100.4 },
      { o: 100.4, h: 100.9, l: 100.2, c: 100.7 },
      // up
      { o: 100.7, h: 100.9, l: 100.3, c: 100.4 },
      // counter
      { o: 100.4, h: 101, l: 100.3, c: 100.95 },
      // up
      { o: 100.95, h: 101.1, l: 100.6, c: 100.7 },
      // counter
      { o: 100.7, h: 101.3, l: 100.6, c: 101.25 },
      // up
      { o: 101.25, h: 101.4, l: 100.9, c: 101 },
      // counter
      { o: 101, h: 101.5, l: 100.95, c: 101.45 },
      // up
      { o: 101.45, h: 101.5, l: 100.8, c: 100.9 },
      // flag
      { o: 100.9, h: 101.2, l: 100.7, c: 100.85 },
      { o: 100.85, h: 101.1, l: 100.6, c: 100.7 },
      { o: 100.7, h: 101.5, l: 100.65, c: 101.4 }
      // breakout
    ],
    annotations: [
      { type: "zone", topPrice: 101.45, bottomPrice: 100, color: "rgba(251, 191, 36, 0.07)", label: "POLE? \u2014 4 counter-bars in 8" },
  ...
  },
  {
    ...
    candles: [
      { o: 105, h: 105.3, l: 104.5, c: 104.6 },
      // pole start (HIDDEN by zoom)
      { o: 104.6, h: 104.8, l: 103.5, c: 103.6 },
      // dropping
      { o: 103.6, h: 103.8, l: 102.6, c: 102.8 },
      { o: 102.8, h: 103, l: 101.6, c: 101.8 },
      // bear pole continuing
      { o: 101.8, h: 102, l: 100.7, c: 100.9 },
      { o: 100.9, h: 102, l: 100.85, c: 101.9 },
      // flag bar 1 (LOOKS bullish if you only see this part!)
      { o: 101.9, h: 102.4, l: 101.85, c: 102.3 },
      // flag bar 2
      { o: 102.3, h: 102.6, l: 102.1, c: 102.5 },
      // flag bar 3
      { o: 102.5, h: 102.7, l: 102.3, c: 102.4 },
      // flag bar 4
      { o: 102.4, h: 102.55, l: 101, c: 101.2 }
      // breakdown CONTINUES bear pole
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      { o: 200, h: 200.2, l: 199.7, c: 199.9 },
      { o: 199.9, h: 200.1, l: 199.6, c: 199.8 },
      { o: 199.8, h: 202.5, l: 199.7, c: 202.4 },
      // pole 1
      { o: 202.4, h: 204.6, l: 202.2, c: 204.5 },
      // pole 2
      { o: 204.5, h: 207, l: 204.4, c: 206.9 },
      // pole 3 — explosive
      { o: 206.9, h: 207.2, l: 205.6, c: 205.8 },
      { o: 205.8, h: 206.2, l: 205.3, c: 205.5 },
      { o: 205.5, h: 205.8, l: 205, c: 205.2 },
      { o: 205.2, h: 207.4, l: 205.1, c: 207.2 }
    ],
    annotations: [
      { type: "zone", topPrice: 207, bottomPrice: 199.7, color: "rgba(0, 217, 160, 0.09)", label: "POLE \u2014 visible in 1 second" },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.3, h: 100.7, l: 99.9, c: 100 },
      { o: 100, h: 100.5, l: 99.7, c: 100.4 },
      { o: 100.4, h: 100.8, l: 100, c: 100.6 },
      // is this the pole?
      { o: 100.6, h: 101, l: 100.4, c: 100.5 },
      // counter
      { o: 100.5, h: 100.9, l: 100.2, c: 100.8 },
      // up again
      { o: 100.8, h: 101.1, l: 100.5, c: 100.6 },
      // counter
      { o: 100.6, h: 101, l: 100.3, c: 100.9 },
      // up
      { o: 100.9, h: 101.2, l: 100.6, c: 100.75 },
      // pause
      { o: 100.75, h: 101, l: 100.5, c: 100.9 },
      // pause
      { o: 100.9, h: 101, l: 100.65, c: 100.85 },
      // pause
      { o: 100.85, h: 101.1, l: 100.7, c: 100.95 },
      // micro breakout
      { o: 100.95, h: 101, l: 100.7, c: 100.8 }
      // and faded
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      { o: 100, h: 100.3, l: 99.7, c: 99.9 },
      { o: 99.9, h: 100.2, l: 99.7, c: 100 },
      { o: 100, h: 102.2, l: 99.9, c: 102.1 },
      // 1️⃣ POLE BAR
      { o: 102.1, h: 103.3, l: 102, c: 103.2 },
      // 2️⃣ POLE BAR
