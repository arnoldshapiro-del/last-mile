...
// Principle 10 — Capitulation Drops Reverse
// Big-volume drops in the first 30 minutes are often selling exhaustion, not trend start.
export const charts = [
  {
    title: 'CAPITULATION SIGNATURE — vertical drop, 2-3x volume, 4-8 bars',
    candles: [
      { o: 105.0, h: 105.4, l: 104.6, c: 105.0 },
      { o: 105.0, h: 105.2, l: 104.8, c: 104.9 },
      { o: 104.9, h: 105.0, l: 102.5, c: 102.6 },   // big drop bar 1
      { o: 102.6, h: 102.7, l: 100.5, c: 100.6 },   // bar 2
      { o: 100.6, h: 100.8, l: 98.5, c: 98.7 },     // bar 3
      { o: 98.7, h: 98.9, l: 96.5, c: 96.6 },       // bar 4 — climax
      { o: 96.6, h: 99.0, l: 96.4, c: 98.8 },       // long-tail hammer
      { o: 98.8, h: 100.6, l: 98.7, c: 100.5 },     // reclaim
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      { o: 105.0, h: 105.4, l: 104.6, c: 105.0 },
      { o: 105.0, h: 105.2, l: 104.8, c: 104.9 },
      { o: 104.9, h: 105.0, l: 102.5, c: 102.6 },
      { o: 102.6, h: 102.7, l: 100.5, c: 100.6 },
      { o: 100.6, h: 100.8, l: 98.5, c: 98.7 },     // chasing entered HERE
      { o: 98.7, h: 98.9, l: 96.5, c: 96.6 },
      { o: 96.6, h: 99.0, l: 96.4, c: 98.8 },       // hammer — short stopped
    ...
    annotations: [
      ...
      { type: 'level', price: 100.0, color: '#ef4444', label: 'STOP — hit on reversal', dash: true },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 98.7, h: 98.9, l: 96.5, c: 96.6 },
      { o: 96.6, h: 99.5, l: 96.4, c: 99.3 },        // LONG-TAIL HAMMER — floor
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 99.3, h: 102.0, l: 99.2, c: 101.95 },     // short-covering
      { o: 101.95, h: 103.5, l: 101.85, c: 103.4 },  // continuation
      { o: 103.4, h: 104.8, l: 103.3, c: 104.7 },
    ],
    annotations: [
      { type: 'volume', bars: [40, 130, 140, 150, 200, 130, 220, 180, 140] },
      { type: 'badge', at: { i: 6, price: 102.0 }, text: 'SHORT COVER', color: '#22c55e' },
  ...
  },
  {
    ...
    candles: [
      { o: 105.0, h: 105.4, l: 104.6, c: 105.0 },
      { o: 104.9, h: 105.0, l: 103.5, c: 103.6 },   // 1️⃣ steep
      { o: 103.6, h: 103.7, l: 101.8, c: 101.9 },
      { o: 101.9, h: 102.0, l: 100.0, c: 100.1 },
      { o: 100.1, h: 100.3, l: 98.0, c: 98.1 },     // 4 bars — short
      { o: 98.1, h: 99.5, l: 97.8, c: 99.4 },        // 3️⃣ hammer
      { o: 99.4, h: 101.0, l: 99.3, c: 100.9 },
    ],
    annotations: [
