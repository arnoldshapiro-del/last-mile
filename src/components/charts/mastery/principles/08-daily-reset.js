const charts = [
  {
    ...
    candles: [
      ...
      // bear setup #1
      { o: 99.1, h: 99.6, l: 99, c: 99.5 },
      // bounce — stopped
      { o: 99.5, h: 100.5, l: 99.4, c: 100.4 },
      { o: 100.4, h: 100.6, l: 99.5, c: 99.6 },
      // bear #2
      ...
      // bounce — stopped
      { o: 100.3, h: 102.5, l: 100.25, c: 102.4 }
      // tempting #4 setup
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.7, h: 102, l: 100.6, c: 101.9 },
      // continued melting up
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 99.6, h: 100, l: 99.4, c: 99.9 },
      { o: 99.9, h: 101, l: 99.8, c: 100.9 },
      { o: 100.9, h: 101.1, l: 100, c: 100.1 },
      { o: 100.1, h: 100.3, l: 99.9, c: 100.2 }
      // L3 stopped — walk away
    ],
    annotations: [
      { type: "badge", at: { i: 1, price: 99.1 }, text: "L1", color: "#ef4444" },
      { type: "badge", at: { i: 4, price: 99.6 }, text: "L2", color: "#ef4444" },
      { type: "badge", at: { i: 7, price: 100.1 }, text: "L3 \u2192 STOP", color: "#fbbf24" },
      { type: "badge", at: { i: 8, price: 100.2 }, text: "\u{1F6AA} WALKED", color: "#22c55e" }
    ],
  ...
  },
  {
    ...
    candles: [
      { o: 100, h: 100.3, l: 99.7, c: 100 },
      { o: 100, h: 100.5, l: 99, c: 99.1 },
      { o: 99.1, h: 100, l: 99, c: 99.9 },
      { o: 99.9, h: 100.1, l: 99, c: 99.1 },
      // L1
      { o: 99.1, h: 99.7, l: 99, c: 99.6 },
      { o: 99.6, h: 99.7, l: 98.6, c: 98.7 },
      // L2
      { o: 98.7, h: 99.5, l: 98.6, c: 99.4 },
      { o: 99.4, h: 99.5, l: 98.4, c: 98.5 },
      // L3
      { o: 98.5, h: 100, l: 98.4, c: 99.9 },
      { o: 99.9, h: 100, l: 98, c: 98.1 },
      // L4 — desperate, full size
      { o: 98.1, h: 98.4, l: 96.5, c: 96.6 }
      // big loss
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.5, h: 100.7, l: 99.6, c: 99.7 },
      // L3
      { o: 99.7, h: 102.5, l: 99.65, c: 102.4 }
      // chart explodes — but you are not watching
    ],
    annotations: [
