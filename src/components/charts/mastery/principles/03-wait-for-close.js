const charts = [
  {
    ...
    candles: [
      ...
      { o: 100.3, h: 100.7, l: 100, c: 100.5 },
      { o: 100.5, h: 100.8, l: 100.2, c: 100.6 },
      { o: 100.6, h: 100.9, l: 100.3, c: 100.4 },
      { o: 100.4, h: 100.7, l: 100, c: 100.3 },
      { o: 100.3, h: 100.6, l: 100, c: 100.5 },
      { o: 100.5, h: 101.2, l: 100.4, c: 100.45 },
      // wick PIERCES trendline, closes inside
      { o: 100.45, h: 100.6, l: 100.1, c: 100.2 },
      { o: 100.2, h: 100.5, l: 99.9, c: 100 }
    ],
    annotations: [
      { type: "trendline", from: { i: 0, price: 100.7 }, to: { i: 8, price: 101 }, color: "#fbbf24", label: "TRENDLINE" },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.4, h: 100.7, l: 100, c: 100.3 },
      { o: 100.3, h: 100.6, l: 100, c: 100.5 },
      { o: 100.5, h: 101.5, l: 100.4, c: 101.4 },
      // FULL CLOSE beyond trendline
      { o: 101.4, h: 102.2, l: 101.3, c: 102.1 },
      { o: 102.1, h: 102.8, l: 102, c: 102.7 }
    ],
    annotations: [
      { type: "trendline", from: { i: 0, price: 100.7 }, to: { i: 8, price: 101 }, color: "#fbbf24", label: "TRENDLINE" },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.2, h: 101.4, l: 100.15, c: 100.25 },
      // wick way up, close right back at open
      { o: 100.25, h: 100.4, l: 99.5, c: 99.6 },
      // immediate breakdown
      { o: 99.6, h: 99.8, l: 99, c: 99.1 }
    ],
    annotations: [
      { type: "trendline", from: { i: 0, price: 100.6 }, to: { i: 8, price: 100.9 }, color: "#fbbf24", label: "TRENDLINE" },
      { type: "arrow", at: { i: 6, price: 101 }, direction: "up", color: "#ef4444", label: "EARLY ENTRY" },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.3, h: 100.5, l: 99.95, c: 100.2 },
      { o: 100.2, h: 101.4, l: 100.15, c: 100.25 },
      // wick + close inside (skipped!)
      { o: 100.25, h: 100.5, l: 100, c: 100.4 },
      { o: 100.4, h: 100.7, l: 100.2, c: 100.6 },
      { o: 100.6, h: 101.5, l: 100.55, c: 101.4 },
      // REAL breakout close
      { o: 101.4, h: 102.2, l: 101.3, c: 102.1 }
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.5, h: 102.4, l: 100.45, c: 102.3 },
      // EXPLOSIVE — 80% range up, all confirm
      { o: 102.3, h: 103.2, l: 102.2, c: 103.1 },
      { o: 103.1, h: 104, l: 103, c: 103.9 }
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      ...
      // close ABOVE — entry
      { o: 101.2, h: 101.3, l: 100, c: 100.1 },
      // bar 8 KILLS the breakout
