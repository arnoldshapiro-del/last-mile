...
// Core Lesson 1 — Pole Mastery — Pole VARIATIONS (single-bar, multi-bar, news-driven, gap, weak)
export const charts = [
  {
    ...
    candles: [
      ...
      { o: 100.0, h: 101.4, l: 99.95, c: 101.3 },   // p1
      { o: 101.3, h: 102.5, l: 101.2, c: 102.4 },   // p2
      { o: 102.4, h: 103.6, l: 102.3, c: 103.5 },   // p3
      { o: 103.5, h: 104.5, l: 103.4, c: 104.4 },   // p4
      { o: 104.4, h: 105.4, l: 104.3, c: 105.3 },   // p5
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.1, h: 100.3, l: 99.9, c: 100.0 },
      { o: 100.0, h: 100.2, l: 99.95, c: 100.05 },
      { o: 100.05, h: 104.5, l: 100.0, c: 104.3 }, // single big candle on news
      { o: 104.3, h: 104.6, l: 103.4, c: 103.6 },
      { o: 103.6, h: 103.9, l: 103.0, c: 103.2 },
      { o: 103.2, h: 105.0, l: 103.1, c: 104.9 },
    ],
    annotations: [
      { type: 'volume', bars: [40, 35, 30, 350, 180, 120, 200] },
      { type: 'badge', at: { i: 3, price: 102.0 }, text: 'NEWS POLE', color: '#22c55e' },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 102.5, h: 102.7, l: 102.1, c: 102.2 }, // shallow pause (≈25% retrace of 1.4-2.5 = 0.4 retrace, 28%)
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.0, h: 101.5, l: 99.95, c: 101.4 },
      { o: 101.4, h: 102.6, l: 101.3, c: 102.5 },
      { o: 102.5, h: 102.7, l: 101.4, c: 101.5 },  // 60% retrace inside
      { o: 101.5, h: 102.0, l: 101.3, c: 101.7 },
      { o: 101.7, h: 103.0, l: 101.6, c: 102.9 },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.0, h: 101.5, l: 99.95, c: 101.4 },
      { o: 101.4, h: 102.6, l: 101.3, c: 102.5 },
      { o: 103.2, h: 104.0, l: 103.15, c: 103.9 }, // GAP UP inside the pole
      { o: 103.9, h: 105.0, l: 103.8, c: 104.9 },
      { o: 104.9, h: 106.0, l: 104.8, c: 105.9 },
      { o: 105.9, h: 107.0, l: 105.85, c: 106.9 },
    ],
    annotations: [
      { type: 'badge', at: { i: 3, price: 103.0 }, text: 'GAP', color: '#22c55e' },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 102.4, h: 104.0, l: 102.3, c: 103.9 },
    ...
    annotations: [
      ...
      { type: 'badge', at: { i: 3, price: 104.0 }, text: 'CONFIRMED', color: '#22c55e' },
    ],
