const charts = [
  {
    ...
    candles: [
      ...
      // pole START — close 100.0
      { o: 100, h: 100.2, l: 99.85, c: 100 },
      { o: 100, h: 102.1, l: 99.95, c: 102 },
      { o: 102, h: 103.5, l: 101.9, c: 103.4 },
      { o: 103.4, h: 105, l: 103.3, c: 104.95 },
      { o: 104.95, h: 105.4, l: 104.85, c: 104.5 },
      // pole END — close 104.5 (wick to 105.4)
      { o: 104.5, h: 104.6, l: 103.5, c: 103.6 }
    ],
    annotations: [
      { type: "level", price: 100, color: "#5eead4", label: "POLE START (close)", dash: false },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 103.4, h: 105, l: 103.3, c: 104.95 },
      { o: 104.95, h: 105, l: 103, c: 103.1 },
      { o: 103.1, h: 103.4, l: 102.4, c: 102.5 },
      // wick to 102.4 — 50% at 102.5
      { o: 102.5, h: 103, l: 102.4, c: 102.9 },
      // tested 50% but closed above
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 103.4, h: 105, l: 103.3, c: 104.9 },
      { o: 104.9, h: 105.4, l: 103.7, c: 103.8 },
      // 50% of 2min
      { o: 103.8, h: 104, l: 102.5, c: 102.6 },
      // 50% of 5min
      { o: 102.6, h: 103, l: 101, c: 101.1 }
      // 50% of 15min
    ],
    annotations: [
      { type: "level", price: 102.65, color: "#5eead4", label: "2-min 50%", dash: true },
      { type: "level", price: 102, color: "#fbbf24", label: "5-min 50%", dash: true },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.5, h: 102, l: 100.4, c: 101.9 },
      // GAP UP at start of pole
      ...
      { o: 103.1, h: 103.3, l: 102.6, c: 102.7 },
      // tests gap-fill, closes above
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 101.95, h: 103.5, l: 101.85, c: 103.4 },
      { o: 103.4, h: 105, l: 103.3, c: 104.95 },
      { o: 104.95, h: 105, l: 104, c: 104.1 },
      { o: 104.1, h: 104.3, l: 103.6, c: 103.7 },
      { o: 103.7, h: 103.9, l: 103.4, c: 103.5 },
      { o: 103.5, h: 103.6, l: 103, c: 103.2 },
      // closest to 50% but holds
      { o: 103.2, h: 105.2, l: 103.15, c: 105.1 }
    ],
    annotations: [
      { type: "level", price: 102.5, color: "#fbbf24", label: "50% LINE", dash: true },
      { type: "zone", topPrice: 105, bottomPrice: 102.5, color: "rgba(34, 197, 94, 0.06)", label: "CONTAINMENT ZONE" }
    ],
