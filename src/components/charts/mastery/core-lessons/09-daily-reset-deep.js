const charts = [
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 99.9, h: 101.2, l: 99.85, c: 101.1 },
      { o: 101.1, h: 101.3, l: 100, c: 100.1 },
      { o: 100.1, h: 102, l: 100.05, c: 101.95 },
      // L4 chase
      { o: 101.95, h: 102, l: 99.5, c: 99.6 }
      // BIG loss
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      ...
      // L3 — closed platform
      { o: 100.1, h: 102, l: 100.05, c: 101.95 },
      // chart goes up — not your problem
      { o: 101.95, h: 103, l: 101.85, c: 102.95 }
    ],
    annotations: [
  ...
  },
  {
    ...
    annotations: [
      { type: "badge", at: { i: 0, price: 100 }, text: "FRESH", color: "#22c55e" },
