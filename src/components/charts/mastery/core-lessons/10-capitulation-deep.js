const charts = [
  ...
  },
  {
    ...
    annotations: [
      ...
      { type: "badge", at: { i: 3, price: 99 }, text: "NEWS HIT", color: "#fbbf24" },
  ...
  },
  {
    ...
    candles: [
      ...
      // NO hammer — just continues
      { o: 93.1, h: 93.3, l: 91.5, c: 91.6 },
      { o: 91.6, h: 91.7, l: 90, c: 90.1 }
    ],
    annotations: [
