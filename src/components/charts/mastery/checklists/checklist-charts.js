...
// Checklist-page teaching charts — visual companions for the rituals.
// Three sets: pre-trade, in-trade, post-trade.

export const preTradeCharts = [
  {
    ...
    annotations: [
      { type: 'zone', topPrice: 104.4, bottomPrice: 100.0, color: 'rgba(0, 217, 160, 0.07)', label: 'POLE' },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 104.95, h: 105.0, l: 103.7, c: 103.8 },
    ],
    annotations: [
  ...
  },
  {
    ...
    annotations: [
      ...
      { type: 'badge', at: { i: 6, price: 102.0 }, text: '4/4 ✓', color: '#22c55e' },
    ],
...
export const inTradeCharts = [
  {
    ...
    candles: [
      ...
      { o: 101.95, h: 103.5, l: 101.85, c: 103.4 },
      { o: 103.4, h: 104.5, l: 103.3, c: 104.4 },
      { o: 104.4, h: 104.6, l: 103.0, c: 103.1 }, // STOP HIT
    ],
    annotations: [
      { type: 'level', price: 103.1, color: '#ef4444', label: 'STOP — 1.8pt risk taken', dash: true },
      { type: 'badge', at: { i: 4, price: 103.0 }, text: 'STOP HIT', color: '#ef4444' },
    ],
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 103.4, h: 105.0, l: 103.3, c: 104.95 },
      { o: 104.95, h: 105.0, l: 103.7, c: 103.8 },
      { o: 103.8, h: 104.0, l: 102.6, c: 102.7 },
      { o: 102.7, h: 102.8, l: 101.7, c: 101.8 }, // closed below 50% (102.5)
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.0, h: 102.0, l: 99.95, c: 101.95 },
      { o: 101.95, h: 103.5, l: 101.85, c: 103.4 },
      { o: 103.4, h: 104.5, l: 103.3, c: 104.4 },   // long
      { o: 104.4, h: 104.6, l: 103.7, c: 103.8 },
      { o: 103.8, h: 104.6, l: 103.7, c: 104.5 },
      { o: 104.5, h: 104.6, l: 102.9, c: 103.0 },   // BEARISH ENGULFING
    ],
    annotations: [
      { type: 'arrow', at: { i: 3, price: 104.4 }, direction: 'up', color: '#5eead4', label: 'LONG' },
      { type: 'badge', at: { i: 6, price: 103.0 }, text: 'BEARISH ENGULF', color: '#ef4444' },
    ],
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 104.4, h: 104.6, l: 103.7, c: 103.8 },
      { o: 103.8, h: 104.0, l: 103.4, c: 103.5 },
      { o: 103.5, h: 105.0, l: 103.45, c: 104.9 },
      { o: 104.9, h: 106.5, l: 104.8, c: 106.4 }, // partial at 1st target
      { o: 106.4, h: 107.5, l: 106.2, c: 107.4 }, // runner
    ],
    annotations: [
      ...
      { type: 'level', price: 105.0, color: '#5eead4', label: 'TRAIL STOP', dash: true },
    ],
...
export const postTradeCharts = [
  {
    ...
    annotations: [
      { type: 'zone', topPrice: 104.4, bottomPrice: 100.0, color: 'rgba(0, 217, 160, 0.07)', label: 'POLE — was it clean?' },
    ],
  ...
  },
  {
    ...
    annotations: [
      { type: 'volume', bars: [40, 45, 50, 45, 40, 35, 200] },
      { type: 'badge', at: { i: 6, price: 102.0 }, text: '4/4 confirmed?', color: '#5eead4' },
    ],
  ...
  },
  {
    ...
    annotations: [
      { type: 'zone', topPrice: 105.0, bottomPrice: 104.7, color: 'rgba(34, 197, 94, 0.10)', label: 'WINDOW' },
