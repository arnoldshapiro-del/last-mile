...
// Inside Bar — pattern_type concept gallery
export const charts = [
  {
    title: 'INSIDE BAR — current bar contained inside prior bar',
    candles: [
      { o: 100, h: 100.3, l: 99.7, c: 100.0 },
      { o: 100.0, h: 101.5, l: 99.5, c: 101.4 },   // mother bar — wide range
      { o: 101.0, h: 101.2, l: 100.0, c: 100.2 },  // INSIDE BAR — high & low both inside mother
      { o: 100.2, h: 102.0, l: 100.15, c: 101.95 }, // breakout up
    ],
    annotations: [
      { type: 'badge', at: { i: 1, price: 101.5 }, text: 'MOTHER', color: '#fbbf24' },
      { type: 'badge', at: { i: 2, price: 101.0 }, text: 'INSIDE', color: '#5eead4' },
  ...
  },
  {
    ...
    candles: [
      { o: 100, h: 100.3, l: 99.7, c: 100.0 },
      { o: 100.0, h: 101.5, l: 99.5, c: 101.4 },
      { o: 101.0, h: 101.2, l: 100.0, c: 100.2 },
      { o: 100.2, h: 102.0, l: 100.15, c: 101.95 },
    ],
    annotations: [
  ...
  },
  {
    ...
    annotations: [
      ...
      { type: 'level', price: 100.0, color: '#fbbf24', label: 'TIGHT STOP — inside-bar low', dash: true },
    ],
  ...
  },
  {
    ...
    candles: [
      { o: 100, h: 100.3, l: 99.7, c: 100.0 },
      { o: 100.0, h: 102.0, l: 99.0, c: 101.8 },   // mother — very wide
      { o: 101.5, h: 101.8, l: 100.5, c: 101.0 },  // inside #1
      { o: 101.0, h: 101.5, l: 100.7, c: 101.3 },  // inside #2 (inside #1)
      { o: 101.3, h: 101.4, l: 100.9, c: 101.1 },  // inside #3
      { o: 101.1, h: 102.5, l: 101.0, c: 102.4 }, // explosive break
    ],
    annotations: [
      { type: 'badge', at: { i: 1, price: 102.0 }, text: 'MOTHER', color: '#fbbf24' },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.0, h: 101.5, l: 99.5, c: 101.4 },
      { o: 101.0, h: 101.2, l: 100.0, c: 100.2 },
      { o: 100.2, h: 101.55, l: 100.15, c: 101.5 }, // break attempt
      { o: 101.5, h: 101.55, l: 99.4, c: 99.5 }, // immediate reversal — closes below mother low
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 102.6, h: 104.0, l: 102.5, c: 103.9 }, // mother bar in uptrend
      { o: 103.5, h: 103.9, l: 102.8, c: 103.0 }, // inside bar — pullback within mother
      { o: 103.0, h: 104.5, l: 102.95, c: 104.4 }, // continuation break
    ],
    annotations: [
      { type: 'badge', at: { i: 3, price: 104.0 }, text: 'MOTHER', color: '#fbbf24' },
