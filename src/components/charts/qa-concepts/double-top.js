const charts = [
  {
    ...
    candles: [
      ...
      // peak 1
      { o: 104.4, h: 104.6, l: 102.5, c: 102.6 },
      // pullback to neckline area
      { o: 102.6, h: 103.5, l: 102.5, c: 103.4 },
      { o: 103.4, h: 104.5, l: 103.3, c: 104.4 },
      // peak 2 = peak 1
      { o: 104.4, h: 104.5, l: 103, c: 103.1 },
      // neckline break starts
      { o: 103.1, h: 103.2, l: 101.5, c: 101.6 }
      // neckline broken
    ],
    annotations: [
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 102.9, h: 105.5, l: 102.85, c: 105.4 },
      // peak 2 EXCEEDS peak 1 = no top
  ...
  },
  {
    ...
    candles: [
      { o: 110, h: 110.3, l: 109.7, c: 110 },
      { o: 110, h: 110.2, l: 108.5, c: 108.6 },
      // already downtrending
      { o: 108.6, h: 108.8, l: 107.2, c: 107.3 },
      { o: 107.3, h: 107.5, l: 106, c: 106.1 },
      { o: 106.1, h: 107.2, l: 106, c: 107.1 },
      // bounce
      { o: 107.1, h: 107.3, l: 106.3, c: 106.4 },
      { o: 106.4, h: 107.2, l: 106.3, c: 107.1 },
      // 2nd bounce — double top against trend
      { o: 107.1, h: 107.2, l: 105.5, c: 105.6 }
      // breakdown resumes trend
    ],
    annotations: [
      { type: "level", price: 107.2, color: "#fbbf24", label: "TWIN PEAKS" },
      { type: "level", price: 106, color: "#ef4444", label: "NECKLINE" },
