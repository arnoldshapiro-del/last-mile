...
// Stop Placement — pattern_type concept gallery (rules across all setups)
export const charts = [
  {
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 101.95, h: 103.5, l: 101.85, c: 103.4 },
      { o: 103.4, h: 104.5, l: 103.3, c: 104.4 },
      { o: 104.4, h: 104.5, l: 103.0, c: 103.2 }, // wick to 103.0 — noise
      { o: 103.2, h: 103.5, l: 103.05, c: 103.3 },
      { o: 103.3, h: 105.0, l: 103.25, c: 104.9 },
    ],
    annotations: [
      { type: 'level', price: 103.0, color: '#fbbf24', label: 'FLAG WICK LOW' },
      { type: 'level', price: 103.0, color: '#ef4444', label: '✗ AT the level — gets hit', dash: true },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.0, h: 102.5, l: 99.5, c: 102.4 }, // wide bar = high ATR
      { o: 102.4, h: 104.0, l: 102.0, c: 103.9 },
      { o: 103.9, h: 105.5, l: 103.5, c: 105.4 },
      { o: 105.4, h: 105.6, l: 103.8, c: 104.0 },
      { o: 104.0, h: 104.3, l: 103.3, c: 103.5 },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 104.9, h: 106.5, l: 104.8, c: 106.4 }, // 1st target hit
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 105.9, h: 105.95, l: 105.0, c: 105.1 }, // higher low — trail
      { o: 105.1, h: 107.0, l: 105.05, c: 106.95 },
      { o: 106.95, h: 107.0, l: 106.0, c: 106.1 }, // higher low — trail
      { o: 106.1, h: 108.0, l: 106.05, c: 107.95 },
    ],
    annotations: [
      { type: 'level', price: 104.85, color: '#94a3b8', label: 'TRAIL #1 — under HL #1', dash: true },
      { type: 'level', price: 105.0, color: '#fbbf24', label: 'TRAIL #2 — under HL #2', dash: true },
      { type: 'level', price: 106.0, color: '#5eead4', label: 'TRAIL #3 — under HL #3', dash: true },
    ],
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 101.95, h: 103.5, l: 101.85, c: 103.4 },
      { o: 103.4, h: 104.5, l: 103.3, c: 104.4 },
      { o: 104.4, h: 104.5, l: 103.0, c: 103.1 }, // approaching stop
      { o: 103.1, h: 103.2, l: 102.0, c: 102.1 }, // would have hit
      { o: 102.1, h: 102.3, l: 100.5, c: 100.6 }, // BIG loss after widened stop
