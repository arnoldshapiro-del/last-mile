...
// Capitulation — pattern_type concept gallery (different angle than principles/10-capitulation)
export const charts = [
  {
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 98.3, h: 100.5, l: 98.2, c: 100.4 }, // confirmation — closed higher than hammer
  ...
  },
  {
    ...
    candles: [
      { o: 105, h: 105.3, l: 104.7, c: 105.0 },     // pre-drop
      { o: 105.0, h: 105.1, l: 102.5, c: 102.6 },
      { o: 102.6, h: 102.7, l: 100.0, c: 100.1 },
      { o: 100.1, h: 100.3, l: 97.5, c: 97.6 },
      { o: 97.6, h: 97.7, l: 95.0, c: 95.1 },        // bottom = 95
      { o: 95.1, h: 98.5, l: 94.8, c: 98.3 },
      { o: 98.3, h: 100.5, l: 98.2, c: 100.4 },      // entry = 100.4
    ],
    annotations: [
      { type: 'level', price: 105.0, color: '#94a3b8', label: 'PRE-DROP HIGH', dash: true },
      { type: 'level', price: 95.0, color: '#94a3b8', label: 'CAPITULATION LOW', dash: true },
      { type: 'level', price: 100.4, color: '#22c55e', label: 'ENTRY' },
      { type: 'level', price: 105.0, color: '#5eead4', label: '1st TARGET — return to pre-drop', dash: true },
      { type: 'level', price: 110.0, color: '#a78bfa', label: '2nd TARGET — 2x drop magnitude', dash: true },
    ],
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.1, h: 100.3, l: 97.5, c: 97.6 },
      { o: 97.6, h: 97.7, l: 95.0, c: 95.1 },
      { o: 95.1, h: 95.4, l: 93.0, c: 93.1 }, // NO hammer — continues lower
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.0, h: 100.4, l: 99.6, c: 100.2 }, // normal trading
    ...
    annotations: [
      ...
      { type: 'badge', at: { i: 3, price: 99.0 }, text: 'NEWS', color: '#fbbf24' },
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.3, h: 100.6, l: 99.7, c: 99.9 }, // OR established
      { o: 99.9, h: 100.0, l: 98.5, c: 98.6 }, // ORB-DOWN entry
      { o: 98.6, h: 98.7, l: 97.5, c: 97.6 },
      { o: 97.6, h: 97.7, l: 96.5, c: 96.6 },
      { o: 96.6, h: 99.5, l: 96.4, c: 99.4 }, // huge reclaim — capitulation pattern
