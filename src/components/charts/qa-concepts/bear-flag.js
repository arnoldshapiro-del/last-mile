const charts = [
  {
    ...
    candles: [
      ...
      { o: 101.2, h: 102.2, l: 101.15, c: 102.1 },
      // flag drift up
      { o: 102.1, h: 102.5, l: 102, c: 102.4 },
      { o: 102.4, h: 102.7, l: 102.2, c: 102.6 },
      { o: 102.6, h: 102.7, l: 100.9, c: 101 }
      // breakdown
    ],
    annotations: [
      { type: "zone", topPrice: 105, bottomPrice: 101.2, color: "rgba(255, 61, 90, 0.07)", label: "POLE" },
      { type: "zone", topPrice: 102.7, bottomPrice: 101.15, color: "rgba(254, 226, 226, 0.07)", label: "FLAG" },
      { type: "arrow", at: { i: 7, price: 101 }, direction: "down", color: "#22c55e", label: "ENTRY" }
    ],
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.6, h: 100.9, l: 100, c: 100.7 },
      { o: 100.7, h: 100.95, l: 100.2, c: 100.3 },
      { o: 100.3, h: 100.5, l: 99, c: 99.1 }
    ],
    annotations: [
      { type: "level", price: 99.1, color: "#22c55e", label: "ENTRY 99.1", dash: false },
      { type: "level", price: 101, color: "#ef4444", label: "STOP \u2014 1 tick over flag high (100.95)", dash: true }
    ],
  ...
  },
  {
    ...
    annotations: [
      ...
      { type: "level", price: 101, color: "#ef4444", label: "STOP", dash: true }
    ],
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.3, h: 100.5, l: 100, c: 100.1 },
      { o: 100.1, h: 100.4, l: 99.85, c: 100 },
      { o: 100, h: 100.2, l: 99.4, c: 99.5 },
      // micro breakdown
      { o: 99.5, h: 100.6, l: 99.4, c: 100.5 }
      // immediate fade
    ],
    annotations: [
