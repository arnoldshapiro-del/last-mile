const charts = [
  {
    ...
    annotations: [
      ...
      { type: "badge", at: { i: 5, price: 100 }, text: "9:30+30", color: "#5eead4" },
  ...
  },
  {
    ...
    annotations: [
      ...
      { type: "level", price: 100, color: "#fbbf24", label: "TIGHT STOP \u2014 mid-OR", dash: true }
    ],
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 99.9, h: 100.4, l: 99.65, c: 100 },
      { o: 100, h: 100.1, l: 98.5, c: 98.6 },
      // ORB-down
  ...
  },
  {
    ...
    candles: [
      ...
      { o: 100.2, h: 100.45, l: 99.85, c: 100 },
    ...
    annotations: [
      { type: "level", price: 100.6, color: "#fbbf24", label: "OR HIGH" },
      { type: "level", price: 99.5, color: "#fbbf24", label: "OR LOW" },
      { type: "badge", at: { i: 5, price: 100 }, text: "INSIDE DAY", color: "#94a3b8" }
    ],
  ...
  },
  {
    ...
    candles: [
      ...
      // ORB-up entry
      { o: 101.3, h: 101.4, l: 100.5, c: 100.6 },
      // immediate roll
      { o: 100.6, h: 100.8, l: 99, c: 99.1 },
      // close BELOW OR low
      { o: 99.1, h: 99.3, l: 98, c: 98.1 }
      // ORB-DOWN now valid
    ],
    annotations: [
      { type: "level", price: 100.7, color: "#fbbf24", label: "OR HIGH" },
