const coreLessons = [
  {
    ...
    teachingUnits: [
      ...
      },
      {
        ...
        answer: "A pole has minimal body overlap, expanding volume, and a steep angle. A slow uptrend has overlapping bodies, steady volume, and a gradual slope. The 5-minute zoom-out is the truth-filter: if it still looks impulsive on 5-min, it is a pole. If it looks like a steady drift, it is just a trend \u2014 and trends without poles do not have flag setups.",
        rules: [
      ...
      },
      {
        ...
        answer: "A gap inside the pole is bullish for that pole. It is committed money jumping price levels with no orders in between \u2014 a strength signal, not a structure break. Treat the pole as continuous through the gap and measure 50% from the pole-start close to the pole-end close as normal.",
        rules: [
  ...
  },
  {
    ...
    teachingUnits: [
      ...
      },
      {
        ...
        answer: "25-50% of the pole. Less than 25% means the pause is too shallow \u2014 the participants who took profit at the pole top have not finished yet, and a deeper pullback is likely coming. More than 50% means the thesis is dead (Principle 4). The 25-50% zone is where buyers (in a bull flag) have absorbed the profit-taking and are ready to push again.",
        rules: [
    ...
    teachingUnits: [
      {
        ...
        answer: "Closes. The pole is defined by what participants committed to, and commitments are recorded in closes. Use the close of the first pole bar as the start, the close of the last pole bar as the end, and find the midpoint. Wicks are noise \u2014 they record probes, not commitments. Measuring from wicks gives you a different (usually wrong) line.",
        rules: [
      ...
      },
      {
        ...
        answer: "Yes. A wick into the 50% with a close back above is a successful retest, not a thesis kill. The bar tested whether the line held \u2014 it did. Hold the trade. The rule fires only on a fully-closed bar below the line.",
        rules: [
  ...
  },
  {
    ...
    teachingUnits: [
      ...
      },
      {
        ...
        answer: "1.5:1 minimum. Below that, the math does not justify the trade. Compute it before clicking: (target \u2212 entry) \xF7 (entry \u2212 stop). The target should be a measured-move projection from the pole length, added to the breakout price. If R:R is 1.4:1 or less, the entry is in the chase zone or the stop is too wide \u2014 pass.",
        rules: [
          "Minimum R:R = 1.5:1",
  ...
  },
  {
    ...
    teachingUnits: [
      ...
      },
      {
        ...
        answer: "At least 1.5x the recent 5-bar average. 2x or higher is the sweet spot. Anything at or below the recent average is a fake \u2014 committed participants leave volume footprints, and a breakout without that footprint is algos painting price. The visual cue: the breakout bar should clearly stand out on the volume pane vs the bars before it.",
        rules: [
    ...
    teachingUnits: [
      {
        ...
        answer: "9:45-10:30 ET (after the opening range establishes and the first directional move develops) and 2:00-3:30 ET (afternoon resumption when institutional desks come back). 10:30-1:30 ET is midday balance and most flag setups fail there. The lunch hour (12:00-1:00 ET) is the worst \u2014 low volume, no commitment, false breaks everywhere.",
        rules: [
      ...
      },
      {
        ...
        answer: "15 minutes. The opening range (first 30 minutes) gives you the floor and ceiling for the morning. The first 15 minutes show whether the session is driving or balancing. Trying to take setups in the first 5 minutes (before the regime is clear) is gambling \u2014 the open often whips both ways before settling.",
        rules: [
      ...
      },
      {
        ...
        answer: "Pass. Ambiguous regime = pass. The cost of skipping a session is small (no trades, flat day). The cost of trading the wrong setup in an unclear regime is large (typical 1-2-3 loss day). When the session refuses to show its hand, the right play is to wait \u2014 it will declare itself eventually, or it will be a balance day with no good directional trades.",
        rules: [
    ...
    teachingUnits: [
      {
        ...
        answer: "2-4 in a clean trend; sometimes more on extended-range days. Each flag is its own trade with its own R:R. Compounded, they often produce 2-3x the result of a single buy-and-hold trend trade \u2014 because each pole-flag step locks profit at the breakout and takes a fresh measured-move target. The staircase is the high-edge trade structure.",
        rules: [
      ...
      },
      {
        ...
        answer: 'Yes \u2014 sometimes more reliable. Flag #1 happens before the trend is confirmed; #2 and #3 happen after the trend has demonstrated itself. As long as the same rules fire (pole, 50% line, healthy flag, four-pillar test), the hit rate is comparable. The "diminishing pole" warning is the only caveat \u2014 if poles are getting visibly smaller step by step, the trend is tiring and target sizes should shrink.',
        rules: [
      ...
      },
      {
        ...
        answer: "Three signals: (1) the most recent pole's 50% line is broken on a close, (2) the session transitions (trend \u2192 range), (3) multi-confirmation fails on what looks like a clean setup. Any one of these = staircase done. Do not try to find one more entry; the next trend will be a fresh structure, not a continuation.",
        rules: [
  ...
  },
  {
    ...
    teachingUnits: [
      ...
      },
      {
        ...
        answer: "Bar +1 is still inside the window \u2014 R:R has degraded slightly but still meets the 1.5:1 minimum. A chase is bar +3 or beyond, where R:R has fallen below 1.5:1. The line is mathematical, not emotional. Use the calculator, not the gut: if R:R \u2265 1.5:1, OK; if R:R < 1.5:1, chase.",
        rules: [
      ...
      },
      {
        ...
        answer: 'Out loud, three sentences, in order: "I missed it." "That one is gone." "Next setup is the next trade." This is not optional repetition \u2014 saying it out loud cuts the chase reflex faster than thinking it. After saying it, look away from the chart for 10 seconds. Then come back fresh. The drill takes 15 seconds; it saves 15 minutes of chase pressure.',
        rules: [
  ...
  },
  {
    ...
    teachingUnits: [
      ...
      },
      {
        ...
        answer: "After. Journaling at the desk during the session keeps the brain on the chart, which keeps the chase reflex alive. Walk outside, get distance, then journal \u2014 the perspective shift is the value. Journal each loss: what was the regime read, did all 4 pillars fire, did I see and ignore a signal, what was my emotional state. Tomorrow opens with that read.",
        rules: [
    ...
    teachingUnits: [
      {
        ...
        answer: "9:30-10:00 ET for stock index futures and equities. The first 15 minutes are most likely to capitulate; 9:45-10:00 is where the climax bar typically prints if the open was a flush. Capitulations OUTSIDE this window are usually news-driven and follow the same shape but at a different time of day.",
        rules: [
