...
// Each principle now includes deep teaching units (Q&A format) — same shape
// as Daily Lessons. Chart galleries are wired in by principle number.
  ...
  },
  {
    ...
    teachingUnits: [
      ...
      },
      {
        ...
        answer:
          'Yes. Wicks may probe the line; closes are the verdict. A wick into the 50% that closes back above is a successful retest, not a thesis kill. Hold the trade. The rule is binary on closes only: a candle that fully closes below the line cancels the thesis; anything else does not.',
        rules: [
    ...
    teachingUnits: [
      {
        ...
        answer:
          'Yes — absolutely. A trending market makes a staircase. Each pole-flag-pole-flag step is its own independent trade with the same rules. Second and third flags are often CLEANER setups because the trend has now confirmed itself. Apply the same checklist every time. The fact that flag #1 carried does not entitle flag #2 to skip a step; the fact that flag #1 was missed does not disqualify flag #2.',
        rules: [
      ...
      },
      {
        ...
        answer:
          'Three signals: (1) the most recent pole\'s 50% line is broken on a close, (2) the session transitions out of trend (chop, range, conflicting trend lines), (3) multi-confirmation fails on a fresh setup that previously would have been clean. Any one of these = staircase done. Stop entering until a fresh pole forms.',
        rules: [
    ...
    teachingUnits: [
      {
        ...
        answer:
          'The window is the 1-3 bars immediately after the breakout close. Bar 8 (the breakout bar) is the ideal entry. Bar 9 is still inside the window; R:R degrades slightly but stays acceptable. Bar 10 is the cliff — by here R:R has fallen below the 1.5:1 minimum. Bar 11 and beyond is a chase: same stop, much worse target, math is broken.',
        rules: [
      ...
      },
      {
        ...
        answer:
          'Chasing feels right because the trend is real. Buyers driving the pole keep buying after you missed it. The chart goes higher. You feel late. Late feels like missing free money. But late is also where the trend ends — chasers buy the top because they are the last buyers. By the time chasing feels easy, the trade is over. The feeling and the math go in opposite directions.',
        rules: [
      ...
      },
      {
        ...
        answer:
          'Three sentences out loud: "I missed it." "That one is gone." "The next setup is the next trade." Drill until automatic. The hardest professional skill in trading is the ability to walk away clean from a missed trade. Without detachment, every missed trade poisons the next one with chase pressure.',
        rules: [
          'Name it: "I missed it"',
  ...
  },
  {
    ...
    teachingUnits: [
      ...
      },
      {
        ...
        answer:
          'Recovery psychology is the headspace where the brain stops analyzing setups and starts trying to "make back" prior losses. Position size grows (revenge sizing). Stops get loose. Discipline slips. The trades taken in this state are not analyzed trades — they are emotional reactions. The 4th, 5th, 6th attempts after losses average 2-3x the planned loss size. Recovery psychology is how a normal red day becomes a blowup.',
        rules: [
